      ...
      <div className="row align-items-center">
        <div className="col-md-6">
          ...
          {data?.p2p_advantage_1_heading && (
            <div className="advantageList d-flex align-items-center pt-5">
              <Image src={data?.p2p_advantage_1_icon} height={50} width={50} />
              <div className="pl-3">
          ...
          {data?.p2p_advantage_2_heading && (
            <div className="advantageList d-flex align-items-center pt-5">
              <Image src={data?.p2p_advantage_2_icon} height={50} width={50} />
              <div className="pl-3">
          ...
          {data?.p2p_advantage_3_heading && (
            <div className="advantageList d-flex align-items-center pt-5">
              <Image src={data?.p2p_advantage_3_icon} height={50} width={50} />
              <div className="pl-3">
          ...
          {data?.p2p_advantage_4_heading && (
            <div className="advantageList d-flex align-items-center pt-5">
              <Image src={data?.p2p_advantage_4_icon} height={50} width={50} />
              <div className="pl-3">
        ...
        <div className="col-md-6">
          <div className="text-center pt-3 pt-md-0 p2pExchangeImg">
            <Image src={data?.p2p_advantage_right_image} alt="" />
          </div>
        </div>
      </div>
    </div>
